  ...
  return (
    <main className="TermsContainer">
      <div className="TermsContent">
      	<h1 className="TermsTitle">Termos e Condições de Uso</h1>
	      <p>
	        Seja bem-vindo ao Toxibook! Estes termos e condições descrevem as regras
	        de uso do site da empresa Toxibook, localizado no endereço
	        <a href="https://toxibook.vercel.app/">[Link]</a>.
	      </p>
	
	      <p>
	        Ao acessar este site, consideramos que você está de acordo com os termos
	        e condições abaixo. Não continue a usar o Toxibook caso você discorde
	        dos termos e condições descritos neste contrato.
	      </p>
	
	      <h2 className="TermsSubTitle">Cookies:</h2>
	      <p>
	        O site usa cookies para ajudar na personalização da sua experiência na
	        internet. Ao acessar o site Toxibook, você concorda com o uso dos
	        cookies requeridos.
	      </p>
	      ...
	      <p>
	        ...
	        para finalidades estatísticas e mercadológicas do nosso site. Você tem a
	        opção de aceitar ou rejeitar os cookies opcionais. Existem alguns
	        cookies obrigatórios, que são necessários para o funcionamento de nosso
	        site. Esses cookies obrigatórios são requerem seu consentimento. Por
	        favor, tenha em mente que, ao aceitar os cookies obrigatórios, você
	        também estará aceitando cookies de terceiros, que podem ser usados por
	        terceiros caso você utilize serviços fornecidos por eles em nosso site –
	        por exemplo, uma janela de reprodução de vídeo fornecida por empresas
	        terceiras e integrada ao nosso site.
	      </p>
	
	      <h2 className="TermsSubTitle">Licença:</h2>
	      <p>
	        Exceto em casos em que for indicado o contrário, Toxibook e seus
	        licenciados têm direito à propriedade intelectual de todo o material
	        postado no Toxibook. Todos os direitos à propriedade intelectual são
	        reservados.
	      </p>
	
	      <h2 className="TermsSubTitle">Você não tem permissão para:</h2>
	
	      <ul className="TermsList">
	        <li>Copiar ou republicar materiais do Toxibook</li>
	        <li>Vender, alugar ou sublocar materiais do Toxibook</li>
	        <li>Reproduzir, duplicar ou copiar materiais do Toxibook</li>
	        <li>Redistribuir conteúdos do Toxibook</li>
	      </ul>
	      ...
	      <p>
	        ...
	        discutir opiniões e informações em determinadas áreas. Toxibook não
	        ...
	        posta. Na extensão em que as leis aplicáveis permitem, Toxibook não se
	      ...
	      <p>
	        Toxibook reserva para si o direito de remover quaisquer Comentários que
	        possam ser considerados inapropriados, ofensivos ou quebrem os Termos e
	        Condições deste contrato.
	      </p>
	
	      <h2 className="TermsSubTitle">Você declara e garante que:</h2>
	
	      <ul className="TermsList">
	        <li>
	          Você tem o direito de postar Comentários em nosso site e tem todas as
	          licenças e consentimentos para tal;
	        </li>
	        <li>
	        ...
	        <li>
	          Seus Comentários não contém material difamatório, injurioso, ofensivo,
	          indecente ou de alguma forma ilícito, que é invasão de privacidade.
	        </li>
	        <li>
	          Seus Comentários não serão usados para solicitar ou promover negócios
	          ou apresentar atividades comerciais ou atividades ilícitas.
	        </li>
	      </ul>
	
	      <p>
	        Você por meio deste concede a Toxibook a licença não-exclusiva de usar,
	      ...
	      <h2 className="TermsSubTitle">Criação de links para nosso conteúdo</h2>
	      <p>
	      ...
	      <ul className="TermsList">
	        ...
	        <li>
	          Distribuidores de diretórios online podem inserir links para nosso
	          Site na mesma maneira que inserem hiperlinks para Sites de outras
	          empresas listadas; e
	        </li>
	        <li>
	      ...
	      <p>
	        ...
	        Toxibook; e (d) o link será inserido em um contexto geral informativo.
	      </p>
	      ...
	      <p>
	        ...
	        informar de seu interesse enviando um e-mail para Toxibook. Por favor,
	      ...
	      <ul className="TermsList">
	        ...
	        <li>
	          Usando qualquer outra descrição do nosso Site que faça sentido dentro
	          do contexto e do formato do conteúdo onde o link está sendo inserido.
	        </li>
	      </ul>
	
	      <p>
	        Não será permitido o uso ou a publicação de links para o logo e/ou
	        outros elementos visuais da Toxibook sem um acordo de licença para o uso
	        da marca registrada.
	      </p>
	
	      <h2 className="TermsSubTitle">Responsabilização pelo Conteúdo:</h2>
	      <p>
	        Não seremos responsabilizados legalmente por qualquer conteúdo que
	        apareça no seu Site. Você concorda em nos proteger e nos defender contra
	        todas as acusações que forem levantadas no seu Site. Nenhum link deve
	        aparecer em qualquer Site que possa ser interpretado como difamatório,
	        obsceno, criminoso, ou que infrinja, viole ou defenda a violação dos
	        direitos de terceiros.
	      </p>
	
	      <h2 className="TermsSubTitle">Reserva de Direitos:</h2>
	      <p>
	      ...
	      <h2 className="TermsSubTitle">Remoção de links postados em nosso site:</h2>
	      <p>
	        Se você encontrar qualquer link em nosso Site que seja de qualquer forma
	        ofensivo, você tem a liberdade de entrar em contato conosco e nos
	        informar do problema a qualquer momento. Vamos considerar as
	      ...
	      <h2 className="TermsSubTitle">Declaração de Isenção de Responsabilidade:</h2>
	      <p>
	      ...
	      <ul className="TermsList">
	        <li>
	          ...
	          mortes ou danos pessoais;
	        </li>
	        <li>
	          limitar ou excluir nossa responsabilidade ou sua responsabilidade por
	          fraudes ou deturpações fraudulentas;
	        </li>
	        <li>
	          limitar nossa responsabilidade ou sua responsabilidade de quaisquer
	          maneiras que não forem permitidas sob a lei;
	        </li>
	        <li>
	          excluir quaisquer responsabilidades suas ou nossas que não podem ser
	          excluídas de acordo com a lei aplicável.
	        </li>
	      </ul>
	      <p>
